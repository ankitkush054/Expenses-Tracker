...
<header>
  <nav style="display: flex; align-items: center; padding: 10px 20px; background: #f5f5f5;">
  ...
  <?php if(isset($_SESSION['Username'])): ?>
    <a href="profile.php" 
       style="font-weight:bold; color:#434343; text-decoration:none;">
